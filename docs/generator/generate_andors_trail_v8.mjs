/**
 * Andor's Trail Content Generator v8
 *
...
// ─── SPRITESHEET COLUMN COUNTS (width / 32) ──────────────────────────────────
const SHEET_COLS = {
  'actorconditions_1':14, 'actorconditions_2':3, 'actorconditions_japozero':16,
  'actorconditions_newb':20, 'actorconditions_omi1':2, 'actorconditions_omi2':5,
  'items_armours':14, 'items_armours_2':7, 'items_armours_3':10,
  'items_books':11, 'items_consumables':14, 'items_jewelry':14,
  'items_misc':14, 'items_misc_2':20, 'items_misc_3':20, 'items_misc_4':20,
  'items_misc_5':9, 'items_misc_6':9, 'items_necklaces_1':10,
  'items_newb':32, 'items_omgeeky':10, 'items_rings_1':10,
  'items_weapons':14, 'items_weapons_2':7, 'items_weapons_3':13,
  'monsters_newb_1':40, 'monsters_newb_2':16, 'monsters_newb_3':20, 'monsters_newb_4':4,
  'monsters_armor1':1, 'monsters_men':9, 'monsters_men2':10,
  'monsters_insects':16, 'monsters_demon1':2, 'monsters_demon2':2,
  'monsters_rats':5, 'monsters_snakes':6, 'monsters_dogs':7, 'monsters_cats':10,
  'monsters_wraiths':3, 'monsters_liches':4, 'monsters_ghost1':1,
  'monsters_skeleton1':1, 'monsters_skeleton2':1, 'monsters_zombie1':1, 'monsters_zombie2':1,
  'monsters_tometik1':10, 'monsters_tometik2':8, 'monsters_rltiles1':20,
};
...
function iconID(sheet, row, col, cols=null) {
  const c = cols ?? SHEET_COLS[sheet] ?? 16;
  return `${sheet}:${(row - 1) * c + (col - 1)}`;
}
...
function makeItem({
  id, name, description='',
  iconSheet='items_misc', iconRow=1, iconCol=1,
...
function buildPickpocketSystem() {
  ...
  const KILL_GOLD_ITEMS = range(19).map(g => {
    ...
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:1, iconCol:8,
      baseMarketCost: g+1,
  ...
  const PICKPOCKET_BAGS = PICKPOCKET_GOLD.map((gold, lvl) => {
    ...
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:3, iconCol:5,
  ...
  range(200).forEach(i => {
    monsters.push(makeMonster({
      ...
      iconSheet:'monsters_men', iconRow:1, iconCol:1+(i%9),
...
function buildTimekeeperSystem() {
  ...
  HOLIDAYS.forEach((h, hi) => {
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:3, iconCol:1+hi,
    ...
    holidayThemeGifts[h.id].forEach((name, i) => {
      items.push(makeItem({
        ...
        iconSheet:'items_misc_2', iconRow:1+hi, iconCol:7+i,
        baseMarketCost: 0, category:'miscellaneous'
      }));
    });
    holidayGoodGifts[h.id].forEach((name, i) => {
      items.push(makeItem({
        ...
        iconSheet:'items_misc_2', iconRow:7+hi, iconCol:7+i,
        baseMarketCost: 0, category:'miscellaneous'
      }));
    });
  ...
  EVENTS.forEach((event, ei) => {
    eventThemeGifts[event].forEach((name, i) => {
      items.push(makeItem({
        ...
        iconSheet:'items_misc_2', iconRow:1+ei, iconCol:13+i,
        baseMarketCost:0, category:'miscellaneous'
      }));
    });
    actorconditions.push(makeActorCondition({
  ...
  items.push(makeItem({
    ...
    displaytype:'quest',
    iconSheet:'items_misc', iconRow:2, iconCol:7,
  ...
  REGIONS.forEach((region, ri) => {
    ...
    range(25).forEach(i => {
      ...
      items.push(makeItem({
        ...
        iconSheet:'items_misc', iconRow:3, iconCol:1+(i%14),
      ...
      monsters.push(makeMonster({
        ...
        iconSheet:'monsters_newb_1', iconRow:1+ri, iconCol:1+i,
  ...
  REGIONS.forEach((region, ri) => {
    forageNames.forEach((base, i) => {
      items.push(makeItem({
        ...
        iconSheet:'items_consumables', iconRow:1, iconCol:1+(i%14),
...
function buildMiningContent() {
  ...
  items.push(makeItem({
    ...
    iconSheet:'items_weapons_2', iconRow:1, iconCol:5,
  ...
  ores.forEach((name, i) => {
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:2, iconCol:1+(i%12),
  ...
  CRYSTALS.forEach((name, i) => {
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:1, iconCol:1+(i%7),
...
function buildCraftingItems() {
  ...
  const CRAFTED_WEAPONS = [
    {id:'weapon_sword_copper',     name:'Copper sword',     dr:2,  ac:5,  base:30,  slot:'weapon', ir:1, ic:1},
    {id:'weapon_sword_iron',       name:'Iron sword',       dr:3,  ac:8,  base:60,  slot:'weapon', ir:1, ic:2},
    {id:'weapon_sword_silver',     name:'Silver sword',     dr:4,  ac:10, base:100, slot:'weapon', ir:1, ic:3},
    {id:'weapon_sword_gold',       name:'Gold sword',       dr:5,  ac:12, base:150, slot:'weapon', ir:1, ic:4},
    {id:'weapon_sword_mithril',    name:'Mithril sword',    dr:7,  ac:15, base:250, slot:'weapon', ir:1, ic:5},
    {id:'weapon_sword_adamantite', name:'Adamantite sword', dr:10, ac:20, base:400, slot:'weapon', ir:1, ic:6},
    {id:'weapon_axe_copper',       name:'Copper axe',       dr:2,  ac:4,  base:25,  slot:'weapon', ir:3, ic:1},
    {id:'weapon_axe_iron',         name:'Iron axe',         dr:4,  ac:7,  base:55,  slot:'weapon', ir:3, ic:2},
    {id:'weapon_axe_silver',       name:'Silver axe',       dr:5,  ac:9,  base:90,  slot:'weapon', ir:3, ic:3},
    {id:'weapon_staff_wood',       name:'Wooden staff',     dr:1,  ac:6,  base:20,  slot:'weapon', ir:5, ic:3},
    {id:'weapon_staff_iron',       name:'Iron staff',       dr:3,  ac:9,  base:80,  slot:'weapon', ir:5, ic:4},
    {id:'weapon_dagger_copper',    name:'Copper dagger',    dr:1,  ac:7,  base:20,  slot:'weapon', ir:2, ic:1},
    {id:'weapon_dagger_iron',      name:'Iron dagger',      dr:2,  ac:10, base:40,  slot:'weapon', ir:2, ic:2},
    {id:'weapon_wand_fire',        name:'Fire wand',        dr:3,  ac:12, base:120, slot:'weapon', ir:5, ic:1},
    {id:'weapon_wand_ice',         name:'Ice wand',         dr:3,  ac:12, base:120, slot:'weapon', ir:5, ic:2},
    {id:'weapon_bow_wood',         name:'Wooden bow',       dr:2,  ac:8,  base:35,  slot:'weapon', ir:4, ic:5},
    {id:'weapon_bow_iron',         name:'Iron bow',         dr:4,  ac:11, base:90,  slot:'weapon', ir:4, ic:6},
  ];
  CRAFTED_WEAPONS.forEach((w) => {
    items.push(makeItem({
      id:w.id, name:w.name,
      description:`A crafted ${w.name.toLowerCase()}.`,
      iconSheet:'items_weapons', iconRow:w.ir, iconCol:w.ic,
  ...
  const CRAFTED_ARMOUR = [
    {id:'armour_leather_head',  name:'Leather cap',          dr:1, base:20,  cat:'head',   ir:2, ic:12},
    {id:'armour_leather_body',  name:'Leather armor',        dr:2, base:40,  cat:'body',   ir:2, ic:1},
    {id:'armour_leather_hand',  name:'Leather gloves',       dr:1, base:15,  cat:'hand',   ir:3, ic:8},
    {id:'armour_leather_feet',  name:'Leather boots',        dr:1, base:15,  cat:'feet',   ir:3, ic:1},
    {id:'armour_chain_head',    name:'Chainmail coif',       dr:3, base:60,  cat:'head',   ir:2, ic:13},
    {id:'armour_chain_body',    name:'Chainmail armor',      dr:5, base:100, cat:'body',   ir:1, ic:6},
    {id:'armour_chain_hand',    name:'Chainmail gauntlets',  dr:2, base:40,  cat:'hand',   ir:3, ic:10},
    {id:'armour_chain_feet',    name:'Chainmail boots',      dr:2, base:40,  cat:'feet',   ir:3, ic:3},
    {id:'armour_plate_head',    name:'Plate helm',           dr:5, base:120, cat:'head',   ir:1, ic:11},
    {id:'armour_plate_body',    name:'Plate armor',          dr:8, base:200, cat:'body',   ir:1, ic:8},
    {id:'armour_plate_hand',    name:'Plate gauntlets',      dr:4, base:80,  cat:'hand',   ir:3, ic:12},
    {id:'armour_plate_feet',    name:'Plate boots',          dr:4, base:80,  cat:'feet',   ir:3, ic:5},
    {id:'armour_robe_mage',     name:"Mage's robe",          dr:1, base:50,  cat:'body',   ir:2, ic:4},
    {id:'armour_robe_cleric',   name:"Cleric's robe",        dr:1, base:50,  cat:'body',   ir:2, ic:3},
    {id:'armour_robe_druid',    name:"Druid's robe",         dr:1, base:50,  cat:'body',   ir:2, ic:2},
    {id:'armour_shield_wood',   name:'Wooden shield',        dr:2, base:25,  cat:'shield', ir:1, ic:1},
    {id:'armour_shield_iron',   name:'Iron shield',          dr:4, base:60,  cat:'shield', ir:1, ic:2},
    {id:'armour_shield_steel',  name:'Steel shield',         dr:6, base:100, cat:'shield', ir:1, ic:3},
  ];
  CRAFTED_ARMOUR.forEach((a) => {
    items.push(makeItem({
      id:a.id, name:a.name,
      description:`Crafted ${a.name.toLowerCase()}.`,
      iconSheet:'items_armours', iconRow:a.ir, iconCol:a.ic,
  ...
  const POTIONS = [
    {id:'potion_health_minor',   name:'Minor health potion',   hp:[10,20],   base:15,  ir:3, ic:1},
    {id:'potion_health_medium',  name:'Medium health potion',  hp:[25,50],   base:30,  ir:3, ic:2},
    {id:'potion_health_major',   name:'Major health potion',   hp:[50,100],  base:60,  ir:3, ic:3},
    {id:'potion_health_full',    name:'Full health potion',    hp:[100,200], base:120, ir:3, ic:4},
    {id:'potion_ap_minor',       name:'Minor action potion',   ap:[10,20],   base:15,  ir:3, ic:5},
    {id:'potion_ap_medium',      name:'Medium action potion',  ap:[25,50],   base:30,  ir:3, ic:6},
    {id:'potion_ap_major',       name:'Major action potion',   ap:[50,100],  base:60,  ir:3, ic:7},
    {id:'potion_antidote',       name:'Antidote',              base:25,                ir:3, ic:8},
    {id:'potion_strength',       name:'Strength potion',       base:40,                ir:4, ic:1},
    {id:'potion_speed',          name:'Speed potion',          base:40,                ir:4, ic:2},
  ];
  POTIONS.forEach(p => {
    const ue = {};
    ...
    items.push(makeItem({
      ...
      iconSheet:'items_consumables', iconRow:p.ir, iconCol:p.ic,
...
function buildGuildItems() {
  ...
  [['lockpick_basic','Basic lockpick','A basic lockpick. Breaks easily.',10],
   ...
   ['lockpick_master_pick','Master pick','The finest lockpick. Rarely breaks.',100],
    ...
    items.push(makeItem({id, name, description,
      iconSheet:'items_misc_4', iconRow:1, iconCol:2+i, baseMarketCost:base, category:'miscellaneous'
    }));
  });
  ...
  ['small_home','mid_home','large_home','luxury_home'].forEach((t,i) => {
    items.push(makeItem({
      ...
      displaytype:'quest',
      iconSheet:'items_books', iconRow:1, iconCol:2+i,
      hasManualPrice:true, baseMarketCost:0, category:'quest'
    }));
  });
  ...
  [['item_door_key','Door key','Opens a standard locked door.'],
   ['item_master_key','Master key','Opens any standard locked door.'],
    ...
    items.push(makeItem({id, name, description,
      iconSheet:'items_misc', iconRow:2, iconCol:9+i, baseMarketCost:20*(i+1), category:'key'
    }));
  });
  ...
  items.push(makeItem({
    ...
    displaytype:'quest',
    iconSheet:'items_misc', iconRow:2, iconCol:11,
    hasManualPrice:true, baseMarketCost:0, category:'quest'
  }));
  ...
  items.push(makeItem({
    ...
    iconSheet:'items_books', iconRow:1, iconCol:8,
  ...
  GUILDS.forEach((guild, gi) => {
    range(12).forEach(level => {
      actorconditions.push(makeActorCondition({
        ...
        category:'spiritual', isPositive:true,
        iconSheet:'actorconditions_1', iconRow:7, iconCol:1+(level%14)
      }));
    });
  });
  ...
  range(200).forEach(i => {
    items.push(makeItem({
      ...
      iconSheet:'items_misc_2', iconRow:1+Math.floor(i/20), iconCol:1+(i%20),
  ...
  RACES.forEach((race, ri) => {
    ...
    range(25).forEach(i => {
      monsters.push(makeMonster({
        ...
        iconSheet:'monsters_men2', iconRow:1, iconCol:1+(i%10),
    ...
    monsters.push(makeMonster({
      ...
      iconSheet:'monsters_men2', iconRow:1, iconCol:1+(ri%10),
    ...
    items.push(makeItem({
      ...
      iconSheet:'items_armours', iconRow:1+Math.floor(ri/14), iconCol:1+(ri%14),
    ...
    actorconditions.push(makeActorCondition({
      ...
      iconSheet:'actorconditions_1', iconRow:7, iconCol:1+(ri%14)
    }));
...
function buildQuestContent() {
  ...
  WITCH_INGREDIENTS.forEach((name, i) => {
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:3, iconCol:1+i,
      hasManualPrice:true, baseMarketCost:0, category:'quest'
    }));
  });
  ...
  actorconditions.push(makeActorCondition({
    ...
    iconSheet:'actorconditions_1', iconRow:2, iconCol:1
  }));
  ...
  range(12).forEach(i => {
    items.push(makeItem({
      ...
      iconSheet:'items_misc', iconRow:1, iconCol:14,
      hasManualPrice:true, baseMarketCost:0, category:'quest'
    }));
  });
  range(6).forEach(i => {
  ...
  ['drow_guard','drow_leader','drow_witch'].forEach((id, i) => {
    monsters.push(makeMonster({
      ...
      iconSheet:'monsters_men', iconRow:1, iconCol:1+i,
  ...
  items.push(makeItem({
    ...
    iconSheet:'items_rings_1', iconRow:1, iconCol:1,
    hasManualPrice:true, baseMarketCost:0, category:'quest'
  }));
  ...
  DEMIGODS.forEach((name,i) => {
    monsters.push(makeMonster({
      ...
      iconSheet:'monsters_demon1', iconRow:1+Math.floor((i%4)/2), iconCol:1+(i%2),
  ...
  monsters.push(makeMonster({
    ...
    iconSheet:'monsters_demon2', iconRow:1, iconCol:1,
  ...
  items.push(makeItem({
    ...
    iconSheet:'items_armours', iconRow:1, iconCol:14,
    ...
    DRAGON_AGES.forEach((age, ai) => {
      ...
      if (age==='adult') {
        items.push(makeItem({
          ...
          iconSheet:'items_armours', iconRow:1, iconCol:5+(ti%9),
  ...
  items.push(makeItem({
    ...
    iconSheet:'items_rings_1', iconRow:1, iconCol:2,
    hasManualPrice:true, baseMarketCost:0, category:'quest'
  }));
  ...
  items.push(makeItem({
    ...
    iconSheet:'items_necklaces_1', iconRow:1, iconCol:5,
  ...
  actorconditions.push(makeActorCondition({
    ...
    category:'spiritual', isPositive:true,
    iconSheet:'actorconditions_1', iconRow:3, iconCol:4,
  ...
  MOON_COLORS.forEach((color, ci) => {
    range(12).forEach(j => {
      monsters.push(makeMonster({
        ...
        iconSheet:'monsters_men2', iconRow:1, iconCol:1+(ci%10),
  ...
  CASTLE_NPCS.forEach(({id, name, conv, msg, qi}) => {
    if (!monsters.find(m=>m.id===id)) {
      monsters.push(makeMonster({
        id, name,
        iconSheet:'monsters_men', iconRow:1, iconCol:1+(monsters.length%9),
...
function buildPokemonContent() {
  ...
  [['beast_orb_1','Spirit orb I','A basic spirit orb. 25% catch rate.',25],
   ['beast_orb_2','Spirit orb II','A good spirit orb. 50% catch rate.',100],
   ['beast_orb_3','Spirit orb III','A great spirit orb. 75% catch rate.',250],
   ['beast_orb_4','Spirit orb IV','A master spirit orb. 95% catch rate.',500],
  ].forEach(([id,name,description,base], idx) => {
    items.push(makeItem({
      id, name, description,
      iconSheet:'items_misc', iconRow:1, iconCol:1+idx,
  ...
  POKEMON_REGIONS.forEach((region, ri) => {
    ...
    pool.forEach((base, bi) => {
      EVOLUTION_TIERS.forEach((tier, ti) => {
        ...
        monsters.push(makeMonster({
          ...
          iconSheet:'monsters_newb_3', iconRow:1+(ri%20), iconCol:1+(bi%20),
        ...
        actorconditions.push(makeActorCondition({
          ...
          category:'mental', isPositive:true,
          iconSheet:'actorconditions_1', iconRow:5, iconCol:1+(bi%14)
        }));
      });
    });
    monsters.push(makeMonster({
    ...
    range(12).forEach(ti => {
      monsters.push(makeMonster({
        ...
        iconSheet:'monsters_men', iconRow:1, iconCol:1+(ti%9),
  ...
  monsters.push(makeMonster({
    ...
    iconSheet:'monsters_men2', iconRow:1, iconCol:2,
...
// ─── LOAD RESOURCES XML (v8 — pattern-based matching for split files) ─────────
...
function buildReadme(tmxFiles, jsonFiles) {
  ...
  return `# Andor's Trail Extended Content Pack v8
## Developer Reference
...
### v8 Change — Split JSON Files
In v8, the monolithic *_jasia.json files from v5 are split by content category.
...
### Content File Naming Convention (per AT spec, v8 split)
...
*Andor's Trail Extended Content Pack v8 — Generated May 2026*
`;
}

// ─── MAIN ─────────────────────────────────────────────────────────────────────
async function main() {
  console.log("=== Andor's Trail Content Generator v8 ===");
  console.log('    Split JSON files by content category (v8 feature)');
  ...
  const outPath = path.join(__dirname, '../andors_trail_content_v8.zip');
  ...
  console.log(`  Output:              andors_trail_content_v8.zip`);
}
